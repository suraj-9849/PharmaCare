      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Fast-moving vs Slow-moving drugs</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              <Skeleton className="h-[300px] w-full" />
            ) : data?.drugMovement ? (
              <DrugMovementTreeMap data={data.drugMovement} />
            ) : (
              <div className="flex h-[300px] items-center justify-center text-gray-500">
                No drug movement data available
              </div>
            )}
          </CardContent>
        </Card>
