...
export const MinimalStatsBar: React.FC<MinimalStatsBarProps> = ({ stats, className }) => {
  ...
  return (
    <div className={cn('flex items-center gap-12 py-6', className)}>
      {stats.map((stat, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-baseline gap-1">
                <motion.span
                  ...
                  className={cn('text-4xl font-bold tabular-nums', colorClass.text)}
                >
                  {stat.value}
                </motion.span>
                {stat.suffix && (
            ...
            {/* Divider */}
            {index < stats.length - 1 && <div className="w-px h-12 bg-slate-200" />}
          </motion.div>
        );
      })}
    </div>
