...
const startServer = async () => {
  try {
    ...
    // Start daily expiry check cron job
    expiryCheckService.startDailyExpiryCheck();
    logger.info('Daily expiry check cron job started');
...
╚═══════════════════════════════════════════════════════════╝
    ...
    // Stop cron jobs
    expiryCheckService.stopDailyExpiryCheck();
