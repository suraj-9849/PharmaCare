...
export type SaleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "totalAmount" | "paymentMethod" | "cashReceived" | "changeGiven" | "saleDate" | "status" | "createdAt" | "updatedAt", ExtArgs["result"]["sale"]>;
